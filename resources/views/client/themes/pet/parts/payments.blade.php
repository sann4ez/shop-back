<ul class="social-icons social-icons-transparent social-icons-icon-light social-icons-lg mb-4">
    <li>
        <svg class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0"
    ...
    <li>
        <svg class="icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img"
    ...
    {{-- <li>
        <svg class="icon" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width="38"
