...
@include('admin.layouts.inc.custom-options')
...
@if(is_dir(public_path('vendor/tinymce')))
    ...
    <script>
        ...
        tinymceOptions = {
            ...
            plugins: 'anchor code table lists autolink emoticons image link visualblocks media preview fullscreen wordcount shortcodes',
            toolbar: 'fullscreen | undo redo | blocks | bold italic | alignleft aligncenter alignright | indent outdent | blockquote | bullist numlist | code | table | link | image | media | preview | wordcount | shortcodes',
            image_caption: true,
            image_title: true,
