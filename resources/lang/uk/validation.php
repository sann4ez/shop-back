...
return [
    ...
    'boolean'              => 'Поле :attribute має містити логічний тип.',
    'confirmed'            => 'Поле :attribute не збігається з підтвердженням.',
    'current_password'     => 'Поле :attribute не є правильним.',
    ...
    'digits'               => 'Довжина цифрового поля :attribute має дорівнювати :digits.',
    'digits_between'       => 'Довжина цифрового поля :attribute має бути від :min до :max.',
    ...
    'max'                  => [
        ...
        'string'  => 'Текст в полі :attribute має мати довжину не більшу за :max.',
    ],
    'mimes'                => 'Поле :attribute має містити файл одного з типів: :values.',
    'mimetypes'            => 'Поле :attribute має містити файл одного з типів: :values.',
    'min'                  => [
        ...
        'string'  => 'Текст у полі :attribute має містити не менше :min символів.',
    ],
    'multiple_of'          => 'Поле :attribute має містити декілька :value',
    ...
    'size'                 => [
        ...
        'string'  => 'Текст у полі :attribute має містити :size символів.',
    ],
    'starts_with'          => 'Поле :attribute має починатися з одного з наступних значень: :values',
    'string'               => 'Поле :attribute має містити текст.',
    ...
    'attributes' => [
        ...
        'code' => 'код',
        'quantity' => 'кількість',
        'payment.gateway' => 'поля спосіб оплати',
        'body' => 'коментар',
        'rating' => 'рейтинг',
        'images.*' => 'зображення',
        'message' => 'повідомлення',
        'model_id' => 'id варіації',
        'CityRef' => 'виберіть місто',
        'CityWarehouses' => 'виберіть відділення',
        ...
        'shipping' => [
            ...
            'novaposhta_courier' => [
                'SettlementTypeCode' => 'тип населеного пункту',
                'RecipientArea' => 'область',
                'RecipientAreaRegions' => 'район',
                'RecipientCityName' => 'місто',
                'RecipientAddressName' => 'вулиця',
                'RecipientHouse' => 'будинок',
    ...
    'Failed captcha validation' => 'Не вдалося пройти перевірку CAPTCHA',
];
